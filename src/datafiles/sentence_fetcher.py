...
def getRandomSentences(numberToGet = 1):
  ...
  if numberToGet > 1:
    ...
    prompt = prompt + 'I also want a mapping between every word and its translation. The Norwegian sentences should be no longer than 100 characters each. Return the response as a JSON of a list of sentences. Do not use Markdown. Here is an example: {[{"Norwegian_sentence": "Han reparerte gamle møbler som hobby", "English_translation": "He repaired old furniture as a hobby", "Word_mapping": {"Han": "He", "reparerte": "repaired", "gamle": "old", "møbler": "furniture", "som": "as", "hobby": "a hobby"}},{"Norwegian_sentence": "De sang sammen på en lokal musikkfestival", "English_translation": "They sang together at a local music festival", "Word_mapping": {"De": "They", "sang": "sang", "sammen": "together", "på": "at", "en": "a", "lokal": "local", "musikkfestival": "music festival"}}]}'
  else:
    prompt = 'I want you to generate a random Norwegian-English sentence pair. I also want a mapping between every word and its translation. The Norwegian sentence should be no longer than 100 characters. Return the response as a JSON. Do not use Markdown. Here is an example: {"Norwegian_sentence": "Hun lærte seg å spille gitar gjennom online kurs", "English_translation": "She learned to play the guitar through online courses", "Word_mapping": {"Hun": "She", "lærte": "learned", "seg": "herself", "å": "to", "spille": "play", "gitar": "guitar", "gjennom": "through", "online": "online", "kurs": "courses"}}'

  #prompt = promptBeginning + 'I also want a mapping between every word and its translation. The Norwegian sentences should be no longer than 100 characters each. Return the response as a JSON of a list of sentences. Do not use Markdown. Here is an example: {[{"Norwegian_sentence": "Han reparerte gamle møbler som hobby", "English_translation": "He repaired old furniture as a hobby", "Word_mapping": {"Han": "He", "reparerte": "repaired", "gamle": "old", "møbler": "furniture", "som": "as", "hobby": "a hobby"}},{"Norwegian_sentence": "De sang sammen på en lokal musikkfestival", "English_translation": "They sang together at a local music festival", "Word_mapping": {"De": "They", "sang": "sang", "sammen": "together", "på": "at", "en": "a", "lokal": "local", "musikkfestival": "music festival"}}]}'
